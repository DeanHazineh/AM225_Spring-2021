...
class fluid_2d {
    public:
         ...
         * multigrid solve. */
        /** Added this array for containing color triplets at each grid point*/
        double* cTripletArray;
        double* const src;
        ...
        void set_boundaries();        
        void init_fields();
        void init_fields_CustomFunc();
		  void resetVelocityPressureField();
  		  void renew_VelocityField1(double xcenter, double ycenter, double circRad);
        void renew_VelocityField2(double xcenter, double ycenter, double circRad);
        
        void init_Color();
        void outputColorField(const char *fname); 			
  		  void AddCircle_colorfield(double xcenter, double ycenter, double circRad, double rcoef, double bcoef, double gcoef);
    ...
    private:
        ...
        inline void color_eno2(double &rd, double &gd, double &bd,double hs,field &f0,field &f1,field &f2,field &f3);
